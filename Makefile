# This Makefile is for the feature::globally extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/feature/globally.pm]
#     AUTHOR => q[awwaiid <awwaiid@thelackthereof.org>]
#     NAME => q[feature::globally]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/feature/globally.pm]
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = feature::globally
NAME_SYM = feature_globally
VERSION = 0.01
...
MAKE = make
FULLEXT = feature/globally
BASEEXT = globally
PARENT_NAME = feature
DLBASE = $(BASEEXT)
VERSION_FROM = lib/feature/globally.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/feature/globally.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/feature
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/feature
...
TO_INST_PM = lib/feature/globally.pm

PM_TO_BLIB = lib/feature/globally.pm \
	blib/lib/feature/globally.pm
...
DISTNAME = feature-globally
DISTVNAME = feature-globally-0.01
...
manifypods : pure_all  \
	lib/feature/globally.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/feature/globally.pm $(INST_MAN3DIR)/feature::globally.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:                feature-globally' >> META_new.yml
	$(NOECHO) $(ECHO) 'version:             0.01' >> META_new.yml
	$(NOECHO) $(ECHO) 'abstract:            Turn on a feature by default everywhere hereafter' >> META_new.yml
	$(NOECHO) $(ECHO) 'license:             ~' >> META_new.yml
	$(NOECHO) $(ECHO) 'author:              ' >> META_new.yml
	$(NOECHO) $(ECHO) '    - awwaiid <awwaiid@thelackthereof.org>' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Turn on a feature by default everywhere hereafter</ABSTRACT>' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '    <AUTHOR>awwaiid &lt;awwaiid@thelackthereof.org&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/feature/globally.pm blib/lib/feature/globally.pm 
